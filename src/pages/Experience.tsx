  ...
  return (
    <div className="mx-auto max-w-6xl px-4 py-16 sm:px-6 sm:py-20">
      <FadeIn>
        ...
        <h1 className="mt-3 text-4xl font-semibold tracking-tight sm:text-5xl">Timeline</h1>
        <p className="mt-4 max-w-2xl text-text-muted">
          Entries below are editable placeholders until real organizations and titles are added in
          the control room. Nothing here invents employment claims.
        </p>
      </FadeIn>

      {entries.length === 0 ? (
        <div className="mt-12 rounded-lg border border-dashed border-border px-6 py-16 text-center">
          <p className="font-mono text-sm text-accent">No experience entries</p>
        </div>
      ) : (
